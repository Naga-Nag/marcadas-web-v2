...
<div class="opciones-dropdown" >
	<button class="opciones-btn" onclick={(e) => {
		...
		<span class="button-text">Opciones</span>
		<svg class="arrow-icon" class:rotated={open} width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	{#if open}
		<div class="opciones-menu" class:visible={open} use:portal bind:this={menuElement} style="opacity: {menuElement && open ? 1 : 0}; transition: opacity 0.2s;">
			...
			<div class="menu-section">
				<h3 class="section-title">
					<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M16 4H18C19.1046 4 20 4.89543 20 6V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V6C4 4.89543 4.89543 4 6 4H8M16 4V2M16 4V6M8 4V2M8 4V6M8 14H16M8 18H12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
					</svg>
					Filtros
				</h3>
...
<style>
	...
	.radio-custom input:checked + .radio-indicator {
		border-color: #667eea;
		background: #667eea;
	}

	.radio-custom input:checked + .radio-indicator::after {
		content: '';
		width: 8px;
		height: 8px;
		border-radius: 50%;
	...
	.checkbox-custom input:checked + .checkbox-indicator .check-icon {
		opacity: 1;
		transform: scale(1);
	}
	...
	.radio-custom input:focus + .radio-indicator,
	.checkbox-custom input:focus + .checkbox-indicator {
