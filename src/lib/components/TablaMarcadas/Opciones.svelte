...
<div class="opciones-dropdown">
	...
	{#if open}
		<div class="opciones-menu" class:visible={open} bind:this={menuElement}>
			...
			<div class="menu-section">
				<h3 class="section-title">
					...
					>
						<path
							d="M16 4H18C19.1046 4 20 4.89543 20 6V18C20 19.1046 19.1046 20 18 20H6C4.89543 20 4 19.1046 4 18V6C4 4.89543 4.89543 4 6 4H8M16 4V2M16 4V6M8 4V2M8 4V6M8 14H16M8 18H12"
							stroke="currentColor"
							stroke-width="2"
							stroke-linecap="round"
							stroke-linejoin="round"
